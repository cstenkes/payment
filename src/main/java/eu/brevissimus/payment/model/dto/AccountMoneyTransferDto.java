...
public record AccountMoneyTransferDto(
        ...
        @Schema(description = "Transfer amount", example = "1000") BigInteger amount,
        @Schema(description = "Transfer to currency", example = "CHF") String currency) {

    public static AccountMoneyTransferDto of(Account fromAccount, Account toAccount, BigInteger amount) {
